 ...
 * A kártyák a parent grid `motion.div`-jén keresztül együtt fade-in-ezhetnek;
 * itt csak a magnetic hover-effect és a hover-state-ek élnek.
 */
export function QuizCard({ audience }: { audience: Audience }) {
  ...
  return (
    <Link
      ...
      style={{
        ...
        transition:
          "transform 480ms cubic-bezier(0.22, 1, 0.36, 1), border-color 620ms cubic-bezier(0.22, 1, 0.36, 1), box-shadow 860ms cubic-bezier(0.22, 1, 0.36, 1)",
      }}
    >
      ...
      >
        <path
          ...
          opacity="0.55"
        />
        <path d="M20 4 V 76" stroke="currentColor" strokeWidth="0.6" opacity="0.4" />
      </svg>
